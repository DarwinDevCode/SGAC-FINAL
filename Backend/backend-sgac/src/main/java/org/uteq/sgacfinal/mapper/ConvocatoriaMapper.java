...
public class ConvocatoriaMapper {
    ...
    public static ConvocatoriaResponseDTO toDTO(Convocatoria entity) {
        ...
        return ConvocatoriaResponseDTO.builder()
                ...
                .fechaInicioPostulacion(entity.getFechaInicioPostulacion())
                .fechaFinPostulacion(entity.getFechaFinPostulacion())
                .fechaPublicacionResultados(entity.getFechaPublicacionResultados())
