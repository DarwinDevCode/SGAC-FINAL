...
public class SesionConfigController {
    ...
    public ResponseEntity<PlanificarSesionResponse> planificar(
    ...
    @PreAuthorize("hasAnyAuthority('AYUDANTE_CATEDRA')")
    public ResponseEntity<CompletarSesionResponse> completar(
            @PathVariable Integer idRegistro,
            @RequestPart("datos") @Valid CompletarSesionRequest request,
