...
import org.uteq.sgacfinal.repository.PeriodoAcademicoRepository;
...
//    @Override
//    @Transactional(readOnly = true)
//    public List<PeriodoAcademicoResponseDTO> listarPorEstado(String estado) {
//        return periodoRepository.findByEstado(estado).stream()
//                .map(this::mapearADTO)
//                .collect(Collectors.toList());
//    }
